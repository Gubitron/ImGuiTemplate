...
namespace ImGuiTemplate.UiBackend
{
    ...
    public class ImGuiController : IDisposable
    {
        ...
        /// </summary>
        public unsafe ImGuiController(GraphicsDevice gd, OutputDescription outputDescription, Sdl2Window window, int width, int height)
        {
            _gd = gd;
            _window = window;
            _windowWidth = width;
        ...
        {
            VeldridImGuiWindow window = (VeldridImGuiWindow)GCHandle.FromIntPtr(vp.PlatformUserData).Target;
            Veldrid.Rectangle bounds = window.Window.Bounds;
        ...
        private unsafe delegate int SDL_GetDisplayUsableBounds_t(int displayIndex, Veldrid.Rectangle* rect);
